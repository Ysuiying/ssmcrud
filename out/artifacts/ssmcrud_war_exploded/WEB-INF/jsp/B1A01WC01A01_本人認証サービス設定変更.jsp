...
<head>
    ...
    <div class="alert-danger text-center">
        <P class="card-text">本人認証サービス設定変更</p>
    </div>

    <form action="/ChangeSer1.action" method="post">
        <div class="container">
            <div class="row text-center"></div>
            <hr>
            <div class="row card-header">本人認証サービス設定</div>
            <div class="row">
                <div class="col-3 bg-aqua">
                    <p>
                    <ul class="list-inline">
                        <li class="list-inline-item">本人認証サービス現在の設定</li>
                    </ul>
                    </p>
                </div>
                <div class="col-4 bg-lemonchiffon">
                    <label><%=session.getAttribute("ser1")%>
                    </label>
                </div>
            ...
            <div class="row">
                <div class="col-3 bg-aqua">
                    <p>
                    <ul class="list-inline">
                        <li class="list-inline-item">本人認証サービス設定変更</li>
                    </ul>
                    </p>
                </div>
                <div class="col-4 bg-lemonchiffon">
                    <div class="custom-control custom-radio custom-control-inline">
                        <input type="radio" class="custom-control-input" id="radio1" name="ser2" value="1">
                        <label class="custom-control-label" for="radio1">SMS</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline">
                        <input type="radio" class="custom-control-input" id="radio2" name="ser2" value="2">
                        <label class="custom-control-label" for="radio2">メール</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline">
                        <input type="radio" class="custom-control-input" id="radio3" name="ser2" value="3">
