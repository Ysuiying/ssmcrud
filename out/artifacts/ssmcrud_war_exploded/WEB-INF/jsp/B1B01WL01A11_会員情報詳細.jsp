...
<div class="container">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-2">
                <a class="btn btn-info btn-lg" href="#" role="button">決済情報照会</a>
            </div>
            <div class="col-2">
                <a class="btn btn-info btn-lg" href="#" role="button">ポイント照会</a>
            </div>
            <div class="col-2">
                <a class="btn btn-info btn-lg" href="#" role="button">カード再発行</a>
            </div>
            <div class="col-2">
                <a class="btn btn-info btn-lg" href="#" role="button">解約キャンセル</a>
            </div>
            <div class="col-2">
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-2 bg-emp">
                <label>市・区・町・村</label>
                <hr>
                <label>建物・部屋番号</label>
            </div>
            <div class="col-8 bg-emp">
