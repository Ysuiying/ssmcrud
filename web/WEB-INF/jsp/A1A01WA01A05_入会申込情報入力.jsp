...
<div class="container">
    ...
    <form action="/insertA1A05.action" method="post"><div class="container">
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-4">
                <input type="text" name="KMSTEL" value="${app.kmstel}" id="KMSTEL" class="form-control" placeholder="<例>03-1111-2222" >
            </div>
            <div class="col-6">
        ...
        <div class="row">
            ...
            <div class="col-4">
                <input type="text" name="KMSJS1" value="${app.kmsjs1}"  class="form-control" placeholder="<例>東京都品川区東品川１－１－１">
                <hr>
                <input type="text" name="KMSJS2" value="${app.kmsjs2}" class="form-control" placeholder="<例>東品川ビル　１０１室">
            </div>
            <div class="col-6"></div>
        </div>
        <br>
        <div class="row">
            ...
            <div class="col-2">
                <input type="text" name="NSHYM"  value="${app.nshym}" id="NSHYM" class="form-control" placeholder="<例>201810">
            </div>
            <div class="col-8">
        ...
        <div class="row">
            ...
            <div class="col-3">
                <ul class="list-inline">
                    <li class="list-inline-item"><input type="text" value="${app.nsg}"  name="NSG" id="NSG" class="form-control" placeholder="<例>320"></li>
        ...
        <div class="text-center">
            <div class="custom-control custom-radio custom-control-inline">
                ...
                <p class="lead"> <a class="btn btn-danger btn-lg" onclick="document:form2.submit();" role="button">戻る</a></p>
            </div>
            <div class="custom-control custom-radio custom-control-inline">
                <p class="lead"> <button class="btn btn-danger btn-lg" type="submit" role="button" <%--disabled--%> id="btn2">次へ進む</button> </p>
            </div>
        </div>
    </form>
...
<script>
    ...
    $(function () {
        $("#KMSTEL").blur(function () {
            ...
            if ((driC.test($("#KMSTEL").val()) == false)) {ktelFlag = false;
        ...
        $("#NSHYM").blur(function () {
            ...
            if ((nshC.test($("#NSHYM").val()) == false)) {nymFlag = false;
        ...
        $("#NSG").blur(function () {
            ...
            if ((nsgC.test($("#NSG").val()) == false)) {nsgFlag = false;
