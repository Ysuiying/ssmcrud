...
<div class="alert-danger text-center">
    <P class="card-text">分割払い設定変更</p>
</div>
<div class="container">
    <div class="row text-center"></div>
    <hr>
    <div class="row card-header">分割払い設定</div>
    <div class="row">
    ...
    <div class="row">
        ...
        <div class="col-4 bg-lemonchiffon">
            <div class="custom-control custom-radio custom-control-inline">
                ...
                <label class="custom-control-label" for="radio1">３回払い</label>
            </div>
            <div class="custom-control custom-radio custom-control-inline">
                <input type="radio" class="custom-control-input" id="radio2" name="test">
                <label class="custom-control-label" for="radio2">6回払い</label>
            </div>
            <div class="custom-control custom-radio custom-control-inline">
                <input type="radio" class="custom-control-input" id="radio3" name="test">
                <label class="custom-control-label" for="radio3">12回払い</label>
            </div>
        </div>
        <div class="col-5 bg-lemonchiffon"></div>
    </div>
