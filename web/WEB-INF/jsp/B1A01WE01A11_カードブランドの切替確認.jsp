...
<div class="alert-danger text-center">
    <P class="card-text">カードブランドの切替</p>
</div>
<div class="container">
    ...
    <hr>
        <div class="row">
        <div class=" col-md-4 card-body card">
            <h5 class="card-title alert-dark"><strong>本人申請のカード</strong></h5>
            <img class="card-img card-img-top" src="../../images/jcbgold.gif" alt="Card image cap"> </div>
        <div class="col-md-4 card-body card">
        <h5 class="card-title alert-dark"><strong>家族申請のカード</strong></h5>
            <img class="card-img card-img-top" src="../../images/JCBw.gif" alt="Card image cap"> </div>
        <div class="col-md-4 card-body card">
        <h5 class="card-title alert-dark"><strong>ETCカードについて</strong></h5>
            <p>ETCカードは本人カード申請済み後、再申請お願い致します。</p>
        </div>
    </div>
    <hr>
